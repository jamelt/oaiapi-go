...
func (u *StepDetails) UnmarshalJSON(data []byte) error {
	...
	var runStepDetailsMessageCreationObject RunStepDetailsMessageCreationObject = RunStepDetailsMessageCreationObject{}
	...
	var runStepDetailsToolCallsObject RunStepDetailsToolCallsObject = RunStepDetailsToolCallsObject{}
	...
	return fmt.Errorf("could not unmarshal `%s` into any supported union types for StepDetails", string(data))
}
...
func (u StepDetails) MarshalJSON() ([]byte, error) {
	...
	return nil, errors.New("could not marshal union type StepDetails: all fields are null")
}
...
// RunStepObjectMetadata - Set of 16 key-value pairs that can be attached to an object. This can be useful for storing additional information about the object in a structured format. Keys can be a maximum of 64 characters long and values can be a maximum of 512 characters long.
