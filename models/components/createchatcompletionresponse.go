...
func (o *Logprobs) GetRefusal() []ChatCompletionTokenLogprob {
	if o == nil {
		return nil
	}
	return o.Refusal
...
func (e CreateChatCompletionResponseServiceTier) ToPointer() *CreateChatCompletionResponseServiceTier {
	return &e
}
func (e *CreateChatCompletionResponseServiceTier) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "scale":
		fallthrough
	case "default":
		*e = CreateChatCompletionResponseServiceTier(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateChatCompletionResponseServiceTier: %v", v)
	}
}
...
type CreateChatCompletionResponse struct {
	...
	ServiceTier *CreateChatCompletionResponseServiceTier `json:"service_tier,omitempty"`
...
func (o *CreateChatCompletionResponse) GetServiceTier() *CreateChatCompletionResponseServiceTier {
	if o == nil {
		return nil
	}
