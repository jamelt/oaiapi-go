...
func (o *RetrieveFineTuningJobResponse) GetHTTPMeta() components.HTTPMetadata {
	if o == nil {
...
func (o *RetrieveFineTuningJobResponse) GetFineTuningJob() *components.FineTuningJob {
	if o == nil {
		return nil
	}
