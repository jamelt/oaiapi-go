...
// Batch - Create large batches of API requests to run asynchronously.
type Batch struct {
...
func (s *Batch) Get(ctx context.Context, batchID string, opts ...operations.Option) (*operations.RetrieveBatchResponse, error) {
	...
	res := &operations.RetrieveBatchResponse{
