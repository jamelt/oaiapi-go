...
// Create - Creates a model response for the given chat conversation. Learn more in the
// [text generation](/docs/guides/text-generation), [vision](/docs/guides/vision),
// and [audio](/docs/guides/audio) guides.
func (s *Chat) Create(ctx context.Context, request components.CreateChatCompletionRequest, opts ...operations.Option) (*operations.CreateChatCompletionResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.CreateChatCompletionResponse
