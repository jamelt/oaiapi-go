...
func (s *Embeddings) Create(ctx context.Context, request components.CreateEmbeddingRequest, opts ...operations.Option) (*operations.CreateEmbeddingResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.CreateEmbeddingResponse
