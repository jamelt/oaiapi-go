...
func (s *Completions) Create(ctx context.Context, request components.CreateCompletionRequest, opts ...operations.Option) (*operations.CreateCompletionResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.CreateCompletionResponse
